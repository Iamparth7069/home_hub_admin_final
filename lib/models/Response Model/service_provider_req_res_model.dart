...
List<ServiceProviderReqResModel> serviceProviderReqResModelFromJson(
    ...
    List<ServiceProviderReqResModel>.from(
        json.decode(str).map((x) => ServiceProviderReqResModel.formMap(x)));
...
class ServiceProviderReqResModel {
  ...
  factory ServiceProviderReqResModel.formMap(Map<String, dynamic> map) {
    return ServiceProviderReqResModel(
